...
export var isGetStationBoardResult = function(obj) {
  if (!obj || !obj.__typename) throw new Error('__typename is missing in "isGetStationBoardResult"')
...
export var isServiceItem = function(obj) {
  if (!obj || !obj.__typename) throw new Error('__typename is missing in "isServiceItem"')
...
export var isServiceLocation = function(obj) {
  if (!obj || !obj.__typename) throw new Error('__typename is missing in "isServiceLocation"')
...
export var isFormationData = function(obj) {
  if (!obj || !obj.__typename) throw new Error('__typename is missing in "isFormationData"')
...
export var isCoachData = function(obj) {
  if (!obj || !obj.__typename) throw new Error('__typename is missing in "isCoachData"')
...
export var isToiletAvailabilityType = function(obj) {
  if (!obj || !obj.__typename) throw new Error('__typename is missing in "isToiletAvailabilityType"')
